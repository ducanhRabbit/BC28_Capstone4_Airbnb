...
export default function UpdataDatPhong({}: Props) {
  const updataBookRoom = useSelector(
    (state: RootState) => state.roomDetailReducer.updataBookRoom
  );
  console.log({ updataBookRoom });
                      ...
                      <div className=" row">
                        <div className="form-group col-4 ">
                          ...
                          <Field
                            ...
                            id="maPhong"
                          />
                          {errors.maPhong && touched.maPhong ? (
                        ...
                        <div className="form-group col-4">
                          ...
                          <Field
                            ...
                            className="form-control"
                          />
                          {errors.ngayDen && touched.ngayDen ? (
                            <p className="text-danger">{errors.ngayDen}</p>
                          ) : null}
                        </div>
                        <div className="form-group col-4">
